...
void Robot::RobotInit() {
  ...
  shooter->SetDefaultBehaviour([this]() {
    return wom::make<ShooterManualControl>(
        shooter, &robotmap.controllers.testController);
  });
  ...
  robotmap.swerveBase.moduleConfigs[0].turnMotor.encoder->SetEncoderOffset(
      0_rad);
  robotmap.swerveBase.moduleConfigs[1].turnMotor.encoder->SetEncoderOffset(
      0_rad);
  robotmap.swerveBase.moduleConfigs[2].turnMotor.encoder->SetEncoderOffset(
      0_rad);
  robotmap.swerveBase.moduleConfigs[3].turnMotor.encoder->SetEncoderOffset(
      0_rad);

  // frontLeft = new ctre::phoenix6::hardware::TalonFX(7, "Drivebase");  //
  // front left frontRight = new ctre::phoenix6::hardware::TalonFX(2,
  // "Drivebase");   // front right backLeft = new
  // ctre::phoenix6::hardware::TalonFX(6, "Drivebase");   // back left backRight
  // = new ctre::phoenix6::hardware::TalonFX(4, "Drivebase");  // back right
  // frontLeft = new ctre::phoenix6::hardware::TalonFX(9, "Drivebase");   //
  // front left frontRight = new ctre::phoenix6::hardware::TalonFX(1,
  // "Drivebase");   // front right backLeft = new
  // ctre::phoenix6::hardware::TalonFX(5, "Drivebase");   // back left backRight
...
void Robot::RobotPeriodic() {
  ...
  robotmap.swerveTable.swerveDriveTable->GetEntry("frontLeftEncoder")
      .SetDouble(robotmap.swerveBase.moduleConfigs[0]
                     .turnMotor.encoder->GetEncoderPosition()
                     .value());
  robotmap.swerveTable.swerveDriveTable->GetEntry("frontRightEncoder")
      .SetDouble(robotmap.swerveBase.moduleConfigs[1]
                     .turnMotor.encoder->GetEncoderPosition()
                     .value());
  robotmap.swerveTable.swerveDriveTable->GetEntry("backLeftEncoder")
      .SetDouble(robotmap.swerveBase.moduleConfigs[2]
                     .turnMotor.encoder->GetEncoderPosition()
                     .value());
  robotmap.swerveTable.swerveDriveTable->GetEntry("backRightEncoder")
      .SetDouble(robotmap.swerveBase.moduleConfigs[3]
                     .turnMotor.encoder->GetEncoderPosition()
                     .value());
