...
std::vector<double>
wom::vision::Limelight::GetAprilTagData(std::string dataName) {
  return table->GetNumberArray(dataName, std::vector<double>(6));
}

units::meters_per_second_t
wom::vision::Limelight::GetSpeed(frc::Pose3d pose1, frc::Pose3d pose2,
                                 units::second_t dt) {
...
void wom::vision::Limelight::OnStart() { std::cout << "starting" << std::endl; }
