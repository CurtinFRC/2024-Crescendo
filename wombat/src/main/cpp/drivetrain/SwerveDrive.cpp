...
wom::SwerveModule::SwerveModule(Subsystem<wom::SwerveModuleConfig, wom::SwerveModuleState> _, wom::ModuleName name) : _name(name) {}

wom::SwerveModule::~SwerveModule() {}

wom::SwerveModule::OnUpdate(units::second_t dt) {
    switch(_state) {
